...
void _C_m3( _class_C *this ){
   ( ( ( void (*) (_class_C *) ) this->vt[_enum_C_m1] )( (_class_C *) this ) );
   printf("%d",1);
   printf("%d",2);
}
...
void _Program_run( _class_Program *this ){
   ...
   _b = new_B();
   ( ( ( void (*)(_class_B *, int ) ) _b->vt[_enum_B_m2] )( _b, 1) );
   _c = new_C();
   ( ( ( void (*)(_class_C * ) ) _c->vt[_enum_C_m1] )( _c) );
   ( ( ( void (*)(_class_C * ) ) _c->vt[_enum_C_m3] )( _c) );
}
